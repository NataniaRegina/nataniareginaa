...
window.addEventListener("load", function () {
  ...
  var img = document.getElementById("rere-btn");
  var modalImg = document.getElementById("img01");
  img.onclick = function () {
    modal.style.display = "block";
    modalImg.src = "./assets/Img/Rere.jpeg";
  };
